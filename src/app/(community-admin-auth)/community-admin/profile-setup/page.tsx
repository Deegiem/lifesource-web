...
const LGAS: Record<string, string[]> = {
  Lagos: [
    "Agege", "Alimosho", "Amuwo-Odofin", "Apapa", "Epe", "Eti-Osa",
  ...
  Rivers: [
    "Bonny", "Degema", "Eleme", "Etche", "Ikwerre", "Obio-Akpor",
    "Okrika", "Port Harcourt",
  ],
  Kano: [
    "Dala", "Fagge", "Gwale", "Kano Municipal", "Kumbotso", "Nassarawa", "Ungogo",
  ],
};
  ...
  return (
    <div className="flex flex-col min-h-screen w-full bg-[#FAFBFF]">
      <div className="px-6 pt-8 pb-4 max-w-lg mx-auto w-full">
        <ScreenHeader onBack={() => router.push("/community-admin/verify")} step={3} totalSteps={4} />

  ...
  return (
    <main className="min-h-screen bg-(--color-text-primary) w-full flex items-center justify-center p-6 md:p-12">
      <div className="w-full max-w-2xl flex flex-col justify-center min-h-[600px] my-auto">
        <div className="flex-1 flex flex-col items-center justify-center px-6 text-center space-y-6 overflow-y-auto pt-8 pb-4">
        ...
        <div className="px-6 pb-6 pt-3 space-y-3 flex-shrink-0 mt-auto">
          <button
